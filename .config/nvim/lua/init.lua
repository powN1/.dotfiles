...
-- table.insert(plugins, { import = "plugins.cmp2" })
...
table.insert(plugins, { import = "plugins.neorg" })
table.insert(plugins, { import = "plugins.diffview" })
table.insert(plugins, { import = "plugins.flutter" })
table.insert(plugins, { import = "plugins.roslyn" })
